...
function bearded_footer_sidebar() {
	...
	$content_top_sidebar = array(
		'id' => 'content_top',
		'name' => _x( 'Contant Top', 'sidebar', 'bearded' ),
	);
	...
	$content_top_sidebar = wp_parse_args( $content_top_sidebar, $defaults );

	register_sidebar($home_sidebar);
	register_sidebar($shop_sidebar);
	register_sidebar($content_top_sidebar);
